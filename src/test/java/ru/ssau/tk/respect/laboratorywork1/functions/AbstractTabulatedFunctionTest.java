...
public class AbstractTabulatedFunctionTest {
    ...
    private static final double[] valuesX1 = new double[]{-15, -3, -1, 0, 1, 3, 15};
    private static final double[] valuesY1 = new double[]{-5, -2, -1, -0, 1, 2};

    private static final double[] valuesX2 = new double[]{-15, -3, -1, 0, 1, 3, 2};
    private static final double[] valuesY2 = new double[]{};

    private static final double[] valuesX3 = new double[]{-15, -3, -1, 0, 1, -1};
    private static final double[] valuesY3 = new double[]{-5, -2, -1, -0, 1, 2, 9};
